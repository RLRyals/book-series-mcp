-- Migration: Add target completion date and fix ROUND casting issues
-- Date: 2025-07-02
...
BEGIN 
    IF NOT EXISTS (
        ...
        ALTER TABLE writing_goals ADD COLUMN target_completion_date DATE;
    END IF;
END $$;

-- Create a helper function for percentage calculation to ensure consistent behavior
...
-- Drop and recreate views using the new helper function
