-- Migration: Fix ROUND to use numeric type
-- Date: 2025-07-02

-- Add weekly_word_goal column if it doesn't exist
DO $$ 
BEGIN 
    IF NOT EXISTS (
        ...
        AND column_name = 'weekly_word_goal'
    ) THEN
        ALTER TABLE writing_goals ADD COLUMN weekly_word_goal INTEGER;
    END IF;
END $$;

-- Drop and recreate views with proper numeric casting
